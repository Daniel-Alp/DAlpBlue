...
void gen_pseudo_moves(Position& pos, std::array<Move, max_moves>& moves, int& num_moves, bool not_quiet);
...
void gen_rook_moves(Position& pos, std::array<Move, max_moves>& moves, int& num_moves, uint64_t targets, uint64_t bishops);
void gen_queen_moves(Position& pos, std::array<Move, max_moves>& moves, int& num_moves, uint64_t targets, uint64_t bishops);
